...
public class CertificateCheckerTest extends TestCase {
	...
	public void testCheckWithGoodCertificate() {
		...
		try {
			checker.check(responseManager);
		} catch (CertificateValidationException e) {
			fail("Certificate check should be OK");
		} catch (SAMLParsingException e) {
			fail("Certificate check should be OK");
		}		
	}

	public void testCheckWithWrongCertificate() {
		// Requete valide (Attributes OK)
		...
		try {
			checker.check(responseManager);
			fail("Invalid Certificate check should fail");
		} catch (CertificateValidationException e) {
			//
		} catch (SAMLParsingException e) {
			fail("Invalid Certificate check should fail");
