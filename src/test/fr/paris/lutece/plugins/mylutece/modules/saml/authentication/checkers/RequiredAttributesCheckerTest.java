...
import fr.paris.lutece.plugins.mylutece.modules.saml.authentication.engine.SAMLTokenExtractor;
...
public class RequiredAttributesCheckerTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		try {
			response = SAMLTokenExtractor.extractSAMLResponse(request);
	...
	public void testCheckMissingRequiredAttribute() {
		...
		try {
			attributesChecker.check(responseManager);
			fail("Attribute check should be fail due to missing attributes");
		} catch (InvalidAttributeException e) {
			//
		} catch (SAMLParsingException e) {
			fail("Attribute check should be fail due to missing attributes");
